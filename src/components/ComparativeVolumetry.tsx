...
interface ComparativeVolumetryProps {
  incidents: Incident[];
  requests: Request[];
  startDate: string;
  endDate: string;
...
export function ComparativeVolumetry({ incidents, requests, startDate, endDate, onClose }: ComparativeVolumetryProps) {
  ...
  return (
    <div className="bg-[#151B2B] p-6 rounded-lg space-y-6 relative">
      ...
      <h2 className="text-xl font-semibold text-white mb-4">Volumetria Comparativa</h2>
